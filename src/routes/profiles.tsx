...
function ProfilesPage(){
  ...
  return <div className="mx-auto max-w-5xl space-y-8"><PageHeader eyebrow="אבטחה" title="פרופילי כניסה" description="יצירה, עריכה והחלפה של סיסמאות. פרטי הסוד נשמרים במנהל האישורים של Windows ולא בקוד."/>
