...
function ProfilesPage(){
  ...
  return <div className="mx-auto max-w-5xl space-y-8"><AutomationContext/><PageHeader eyebrow="כניסה לאתר" title="חשבונות התחברות לאתר" description="בחר את החשבון שהאוטומציה תשתמש בו. הסיסמה נשמרת במנהל האישורים של Windows ולא בקוד."/>
